    ...
    class default_node_core
    {
        constructor(node_shell,x,y,w,h)
        {
            //create the body element
                ...
                this.body_html_shape=golpal_shape_creator.create_rectangle(2,2,w-4,h-4,"blue");
                this.body_element=new element(node_shell.node_id,"body_element",this.body_html_shape,x,y,w,h);
                // this.body_element.draw();

            //create the resizer element
                this.resizer_html_shape=golpal_shape_creator.create_rectangle(0,0,10,10,"blue");
                this.resizer_element=new element(node_shell.node_id,"resizer", this.resizer_html_shape,x+w,y+h,10,10);
    ...
    class test_node_core
    {
        constructor(node_shell,x,y,w,h)
        {
            //create the body element
                ...
                this.node_id = node_shell.node_id;
                //create a specific shape for this core .. this may change for each core type
                var body_html_shape=golpal_shape_creator.create_rectangle(20,20,w-4,h-4,"blue");
